...
const ReactProjects = () => {
    ...
    const reactprojectsCat = projects.filter(item => item.category === 1);
    ...
    const totalProjects = reactprojectsCat.length;
    const indexOfLastProject = currentPage * projectsPerPage;
    const indexOfFirstProject = indexOfLastProject - projectsPerPage;
    const currentProjects = reactprojectsCat.slice(indexOfFirstProject, indexOfLastProject);
